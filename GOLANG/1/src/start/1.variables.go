...
func main() {
	...
	nameTwo := "Luigi" //without string | Implicit
	fmt.Println(nameTwo)
	...
	/*
		*  Ranges:
		?  8-bits : -128 through 127.
		? 16-bits : -32768 through 32767.
		? 32-bits : -2147483648 through 2147483647
		? 64-bits :  -9223372036854775808 through 9223372036854775807
